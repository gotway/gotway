...
func (_m *CacheRepo) DeleteCacheByPath(paths []core.CachePath) error {
	ret := _m.Called(paths)
...
func (_m *CacheRepo) GetCache(path string, serviceKey string) (core.Cache, error) {
...
func (_m *CacheRepo) GetCacheDetail(path string, serviceKey string) (core.CacheDetail, error) {
	ret := _m.Called(path, serviceKey)
...
func (_m *CacheRepo) StoreCache(cache core.CacheDetail, serviceKey string) error {
